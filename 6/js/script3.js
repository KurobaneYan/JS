...
getById('showForm').onclick = () => {
    ...
    getById('form').appendChild(createForm());
...
function createForm() {
    ...
    firstNameInput.setAttribute('placeholder', 'Richard');
    firstNameGroup.appendChild(firstNameInput);

    let patronymicGroup = document.createElement('div');
    let patronymicLabel = document.createElement('label');
    patronymicLabel.setAttribute('for', 'patronymic');
    patronymicLabel.textContent = 'Patronymic';
    patronymicGroup.appendChild(patronymicLabel);
    let patronymicInput = document.createElement('input');
    patronymicInput.id = 'patronymic';
    patronymicInput.setAttribute('placeholder', 'Matthew');
    patronymicGroup.appendChild(patronymicInput);
    ...
    lastNameInput.setAttribute('placeholder', 'Stallman');
    lastNameGroup.appendChild(lastNameInput);

    let sexGroup = document.createElement('div');
    let sexLabel = document.createElement('label');
    sexLabel.setAttribute('for', 'sex');
    sexLabel.textContent = 'Sex';
    
    let maleRatio = makeRadioButton('sex', 'male', 'male');
    
    sexGroup.appendChild(sexLabel);
    
    sexGroup.appendChild(maleRadio);

    form.appendChild(firstNameGroup);
    form.appendChild(patronymicGroup);
